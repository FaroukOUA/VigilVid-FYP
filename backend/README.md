...
`GAME_CLIP_TRANSCODE_MODE=auto` uses `ffprobe` to serve phone-safe H.264 clips
directly and transcodes only risky source encodings. If Uvicorn cannot find
